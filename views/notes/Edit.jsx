    ...
    render() {
        ...
        return (
            <DefaultLayout>
                ...
                <form action={`/notes/${note._id}?_method=PUT`} method="post" className="mt-4 formhorizontal">
                    ...
                    <div class="form-group row mb-3">
                        <div className='col-sm-10'>
                            <textarea type="text" name="body" defaultValue={note.body} className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                        </div>
                    </div>
                    <input type="submit" value="Update Note" className='btn btn-outline-success'/>
                </form>
